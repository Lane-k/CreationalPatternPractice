...
as before, I will use a 3 folder approach with an include for header files, an src for my .cpp implementations and a mains for my .cpp main files for each showcase. 
